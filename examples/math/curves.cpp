...
auto main() -> int {
  ...
  std::println("{:<26} {:.4f}", "bezier_cubic t=0.5", nm::bezier_cubic(b0, b1, b2, b3, 0.5));
  std::println(
    "{:<26} {:.4f}", "bezier tangent t=0.5", nm::bezier_cubic_tangent(b0, b1, b2, b3, 0.5)
  );
  ...
  for (double t : {0.0, 0.5, 1.0}) {
    std::println("{:<26} {:.4f}", "catmull_rom", nm::catmull_rom(c0, c1, c2, c3, t));
  }
