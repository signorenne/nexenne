 ...
 */
[[nodiscard]] auto read_chip_info(chip_id const chip) -> result<chip_info>;
 ...
 * @post No line state is touched.
 */
[[nodiscard]] auto read_line_info(chip_id const chip, line_offset const offset)
  -> result<line_info>;
 ...
 * @post No line state is touched.
 */
[[nodiscard]] auto find_line(chip_id const chip, std::string_view const name)
