 ...
 * and the rotation types (unit quaternions with slerp variants, Euler angles).
 * The geometric samplers and the hashing and formatting support join this list as
 * they are ported.
 */
