...
TEST_CASE("order matters: xyz differs from zyx for the same angles") {
  math::euler_angles<double> const a{math::radians{0.3}, math::radians{0.5}, math::radians{0.7}};
...
TEST_CASE("from_ypr equals intrinsic zyx and quaternion::from_euler") {
  ...
  auto const ypr{math::from_ypr(math::radians{yaw}, math::radians{pitch}, math::radians{roll})};
  auto const zyx{math::to_quaternion(
    math::euler_angles<double>{math::radians{roll}, math::radians{pitch}, math::radians{yaw}},
...
TEST_CASE("all six orders produce unit quaternions") {
  math::euler_angles<double> const a{math::radians{0.2}, math::radians{0.4}, math::radians{0.6}};
  for (auto order :
       {math::euler_order::xyz,
